...
class IDX_TBL {
  ...
  public:
    int  libb_last;          // libb last
    int  lib_step;           // when libb_curr - libb_last is bigger then lib_step, delete longseq
    IDX_TBL();
    void init(int, int);
    void clean();
    void init_capacity(int);
    void set_dna();
    int  read_tbl(char *);
    int  read_tbl_seg(char *, int, int);
    int  write_tbl(char *);
    int  write_tbl_seg(char *, int, int);
    int  add_word_list(int, int *, INTs *, int);
    int  add_word_list2(int, int *, INTs *, int);
    int  add_word_list2_costly(int, int *, INTs *, int);
